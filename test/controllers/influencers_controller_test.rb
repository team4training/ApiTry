...
class InfluencersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create influencer' do
    assert_difference('Influencer.count') do
      post influencers_url, params: { influencer: { bio: @influencer.bio, image: @influencer.image, name: @influencer.name } }
    end
  ...
  test 'should update influencer' do
    patch influencer_url(@influencer), params: { influencer: { bio: @influencer.bio, image: @influencer.image, name: @influencer.name } }
